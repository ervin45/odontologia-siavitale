...
public class DetalleDocProveedorV extends Application {
	
	Stage escenario0 = new Stage();
	DocProveedor actual = null;
	
	@Override
	public void start(Stage escenario) {
		escenario.setTitle("Detalle Documentos Proveedor");
		escenario0 = escenario;
		try {
			FXMLLoader cargador2 = new FXMLLoader(Principal.class.getResource("DetalleDocProveedor.fxml"));
//			cargador2.setController(new DetalleDocProveedorController());
...
//			escenario0.setResizable(false);
			...
			escenario0.show();
			cargador2.<DetalleDocProveedorController>getController().setDocumento(actual);
...
//	    });
	...
	public void setDocumento(DocProveedor doc)
	{
		actual = doc;
	}
