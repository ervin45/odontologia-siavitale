...
public class ExperienciaV extends Application {

	Stage escenario0;
	
	@Override
	public void start(Stage escenario) {
		escenario.setTitle("Experiencia");
		escenario0 = escenario;
		try{
			FXMLLoader cargador2 = new FXMLLoader(Principal.class.getResource("DescriGralView.fxml"));
			cargador2.setController(new ExperienciaController());
			...
			escenario0.show();
			System.out.println("Muestra la Ventana Eexperiencia???");
		}catch(IOException e) {
