...
public class MarcaController {
	...
	@FXML
	private TableColumn<Marca, String> ColCodigo;
	...
	private ObservableList<Marca> tablaarray = FXCollections.observableArrayList();
	
	private Marca actual = null;
...
//	}
	...
	private void initialize() {
		...
		titulo.setText("Marca");
		
		ColCodigo.setCellValueFactory(new PropertyValueFactory<Marca, String>("Codigo"));
	...
	private void mostrarTablaDetalles(Marca mostrar) {
		if (mostrar != null)
		{
...
//			tfCodigo.setText("");
	...
	private void clickbotonBorrar()
	{
		...
		Marca Dborrar = Tabla.getSelectionModel().getSelectedItem();
...
//			tfStatus.setEditable(false);				
	...
	{
		Marca modi = Tabla.getSelectionModel().getSelectedItem();
		actual = modi;
		System.out.println("Entroó en Botón Borrar!!!!");
		if (modi != null)
		{
...
//			actual.setCodigo(tfCodigo.getText());
	...
	{
		Marca sel = Tabla.getSelectionModel().getSelectedItem();
		actual = sel;
		mostrarTablaDetalles(actual);
		modifica = false;
		edicion(false);
