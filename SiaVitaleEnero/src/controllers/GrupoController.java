...
public class GrupoController {
	...
	@FXML
	private TableView<GrupoProducto> Tabla;
	
	@FXML
	private TableColumn<GrupoProducto, String> ColCodigo;
	
	@FXML
	private TableColumn<GrupoProducto, String> ColDescripcion;
	...
	private ObservableList<GrupoProducto> tablaarray = FXCollections.observableArrayList();
	
	private GrupoProducto actual = null;
...
//	}
	...
	private void initialize() {
		...
		titulo.setText("Grupo de Productos");
		
		ColCodigo.setCellValueFactory(new PropertyValueFactory<GrupoProducto, String>("Codigo"));
		ColDescripcion.setCellValueFactory(new PropertyValueFactory<GrupoProducto, String>("Descripcion"));
		
		Tabla.setColumnResizePolicy(TableView.UNCONSTRAINED_RESIZE_POLICY);
		
		mostrarTablaDetalles(null);
		
		Tabla.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<GrupoProducto>(){
	...
	private void cargarTabla() {
		...
		try {
			...
			Query queryResult = sesion.createQuery("from GrupoProducto");
	...
	private void mostrarTablaDetalles(GrupoProducto mostrar) {
		if (mostrar != null)
		{
...
//			tfCodigo.setText("");
	...
	private void clickbotonBorrar()
	{
		...
		GrupoProducto Dborrar = Tabla.getSelectionModel().getSelectedItem();
...
//			tfStatus.setEditable(false);				
	...
	{
		GrupoProducto modi = Tabla.getSelectionModel().getSelectedItem();
		actual = modi;
		System.out.println("Entroó en Botón Borrar!!!!");
		if (modi != null)
		{
...
//			actual.setCodigo(tfCodigo.getText());
	...
	{
		GrupoProducto sel = Tabla.getSelectionModel().getSelectedItem();
		actual = sel;
		mostrarTablaDetalles(actual);
		modifica = false;
		edicion(false);
