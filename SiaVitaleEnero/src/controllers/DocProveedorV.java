...
public class DocProveedorV extends Application {
	
	Stage escenario0;
	
	@Override
	public void start(Stage escenario) {
		escenario.setTitle("Documentos Proveedores y Beneficiarios");
		escenario0 = escenario;
		try {
			FXMLLoader cargador2 = new FXMLLoader(Principal.class.getResource("DocProveedorView.fxml"));
			cargador2.setController(new DocProveedorController());
