...
public class PresentacionV extends Application {
	
	Stage escenario0;
	
	@Override
	public void start(Stage escenario) {
		escenario.setTitle("Presentacion");
		escenario0 = escenario;
		try {
			FXMLLoader cargador2 = new FXMLLoader(Principal.class.getResource("PresentacionView.fxml"));
			cargador2.setController(new PresentacionController());
