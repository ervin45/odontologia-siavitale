...
public class DescriGralController {

	@FXML
	private TableView<DescriGral> Tabla;
...
//	}
	...
	private void initialize() {
		...
		ColCodigo.setCellValueFactory(new PropertyValueFactory<DescriGral, String>("Codigo"));
	...
	private void mostrarTablaDetalles(DescriGral mostrar) {
		if (mostrar != null)
		{
...
//			tfCodigo.setText("");
	...
	private void clickbotonBorrar()
	{
		...
		DescriGral Dborrar = Tabla.getSelectionModel().getSelectedItem();
...
//			tfStatus.setEditable(false);				
	...
	{
		DescriGral modi = Tabla.getSelectionModel().getSelectedItem();
		actual = modi;
		System.out.println("Entroó en Botón Borrar!!!!");
		if (modi != null)
		{
...
//			actual.setCodigo(tfCodigo.getText());
	...
	{
		DescriGral sel = Tabla.getSelectionModel().getSelectedItem();
		actual = sel;
		mostrarTablaDetalles(actual);
		edicion(false);
		enableboton();
